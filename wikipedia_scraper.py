...
def scrape_wikipedia_with_selenium(url):
    ...
    with open('arabicData.txt', 'a', encoding='utf-8') as file:
...
wikipedia_urls = ['https://ar.wikipedia.org/wiki/التطهير_العرقي_في_ناميبيا','https://ar.wikipedia.org/wiki/حنبعل','https://ar.wikipedia.org/wiki/عليسة']
for url in wikipedia_urls:
    scrape_wikipedia_with_selenium(url)
